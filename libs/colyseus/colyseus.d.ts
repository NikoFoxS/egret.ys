...
declare namespace Colyseus {
    class Client {
        ...
        joinOrCreate<T>(roomName: string, options?: any, rootSchema?: any): Promise<Room<T>>;
        create<T>(roomName: string, options?: any, rootSchema?: any): Promise<Room<T>>;
        join<T>(roomName: string, options?: any, rootSchema?: any): Promise<Room<T>>;
        joinById<T>(roomId: string, options?: any, rootSchema?: any): Promise<Room<T>>;
...
declare namespace Colyseus {
    type FunctionParameters<T extends (...args: any[]) => any> = T ;
...
declare namespace Colyseus {
    class Room<T> extends StateContainer<T> {
        id: string;
        sessionId: string;
        name: string;
        onStateChange: {
        ...
        onMessage<T>(type: "*", callback: (type: string | number | any, message: T) => void): any;
        onMessage<T extends (new (...args: any[]) => any)>(type: T, callback: (message: any) => void): any;
        onMessage<T>(type: string | number, callback: (message: T) => void): any;
        removeAllListeners(): void;
    }
